...
class opAdam_lopSGDHD(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8, momentum_h=0.9, dampening_h=0, nesterov_h=False,
        ...
        super(opAdam_lopSGDHD, self).__init__(params, defaults)
